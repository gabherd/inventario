...
@section('content')
	<div class="content-page">
		...
		<!--Modal product-->
	<div class="modal fade" id="mdl-save-product-over"  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      <div class="modal-footer d-flex justify-content-around">
		        ...
		        <button id="btn-save-product-over" data-submit="create" class="btn btn-primary">Guardar</button>
		      </div>
		    </div>
		  </div>
	</div>
